    ...
    return (
        <div className="flex flex-col justify-between overflow-hidden border rounded-2xl">
            ...
            <div className="flex">
                    ...
                    <div className="flex items-center justify-center w-full py-2 bg-teal-600 text-slate-50 hover:bg-teal-800">
                        <button>Editar</button>
                    </div>
    

                
                    <div className="flex items-center justify-center w-full bg-red-500 text-slate-50 hover:bg-red-700">
